...
class EnhancedSQLValidator:
    ...
    def save_simplified_report(self, results_df: pd.DataFrame) -> str:
        ...
        output_file = os.path.join(output_dir, f"单轮对话准确度匹配结果_{timestamp}.xlsx")
...
if __name__ == "__main__":
    ...
    API_KEY = "ragflow-_1hWWlBHT52ZPReD5txY1BHWCzo8wzajTNtg5ElkJ8A"
    AGENT_ID = "448f0a18e9e711f0955f0242ad420006"
    DATASET_IDS = ["a0c2dfacca6211f0be540242c0a85006"]
    EXCEL_PATH =  "新博报表q_sql_v2.1.1.xlsx"
